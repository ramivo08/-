				...
				<div class="search_box">
					...
					<div class="type2 inputWrap">
						...
						<div class="part">
							...
							<input id="searchCont" name="searchCont" title="검색어"
					...
					<table class="basic administer_delivery">
						...
						<tbody>
							...
							<tr>
								...
								<td>9751042</td>
								<td class="nameTd"><a
									href="javascript:selectDelivery('${deliveryMgmtList.objAdresNo}');">이사부(ISABU)</a></td>
								<td>KOR</td>
								<td>UV</td>
								<td>3000t</td>
								<td>2020-05-20</td>
							...
							<tr>
								...
								<td>9751043</td>
								<td class="nameTd"><a
									href="javascript:selectDelivery('${deliveryMgmtList.objAdresNo}');">온누리(ONNURI)</a></td>
								<td>KOR</td>
								<td>UV</td>
								<td>2000t</td>
								<td>2020-05-20</td>
							...
							<tr>
								...
								<td>9751044</td>
								<td class="nameTd"><a
									href="javascript:selectDelivery('${deliveryMgmtList.objAdresNo}');">이어도(EARDO)</a></td>
								<td>KOR</td>
								<td>UV</td>
								<td>1500t</td>
								<td>2020-05-20</td>
							...
							<tr>
								...
								<td>9751045</td>
								<td class="nameTd"><a
									href="javascript:selectDelivery('${deliveryMgmtList.objAdresNo}');">장목1호(JM-1)</a></td>
								<td>KOR</td>
								<td>UV</td>
								<td>500t</td>
								<td>2020-05-20</td>
							...
							<tr>
								...
								<td>9751046</td>
								<td class="nameTd"><a
									href="javascript:selectDelivery('${deliveryMgmtList.objAdresNo}');">장목2호(JM-2)</a></td>
								<td>KOR</td>
								<td>UV</td>
								<td>500t</td>
								<td>2020-05-20</td>
