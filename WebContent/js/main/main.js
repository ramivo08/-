...
//			, cellText: false, cellDates:true,dateNF:'yyyy-mm-dd hh:mm:ss'	
//			 cellText:false, cellDates:true,dateNF:'yyyy-mm-dd hh:mm:ss cellNF:true,   '
//			, cellDates:true,dateNF:'yyyy-mm-dd hh:mm:ss'
	        ...
	        //var jsonObj = XLSX.utils.sheet_to_html(worksheet,{});
	        var jsonObj = XLSX.utils.sheet_to_json(worksheet,{});
	        foundationJson = jsonObj;
	        //console.log("read array : "+ workbook);
	        //console.log("sheet to json : " + jsonObj);
...
//	        	values.push( Object.values(jsonObj[i]));
//	        }
//	        	
	    	grid.clear()
//			const rows = 
